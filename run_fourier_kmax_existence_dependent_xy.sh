...
#SBATCH --output=isodepth_fourier_kmax_existence_dependent_xy-%j.log
...
# Step 4: Run the dependent-xy Fourier k_max existence-only study.
python -m experiments.fourier_kmax_sweep \
  --spec ./configs/experiments/fourier_kmax_existence_dependent_xy_study.json

# Step 5: Run the dependent-xy Fourier k_max existence-only analysis.
